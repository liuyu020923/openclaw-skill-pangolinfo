...
Semantic usage (no URL required):
    pangolin_amazon.py --content B0DYTF8L2W --mode amazon --site amz_us
    pangolin_amazon.py --q "wireless mouse" --mode amazon --site amz_us
    pangolin_amazon.py --content B00163U4LK --mode review --site amz_us

Legacy usage (URL-based):
    pangolin_amazon.py --url "https://amazon.com/dp/..." --mode amazon
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "Examples:\n"
            "  python3 pangolin_amazon.py --asin B0DYTF8L2W --site amz_us\n"
            '  python3 pangolin_amazon.py --q "wireless mouse" --site amz_us\n'
            "  python3 pangolin_amazon.py --content electronics --parser amzBestSellers --site amz_us\n"
            "  python3 pangolin_amazon.py --content B00163U4LK --mode review --filter-star critical\n"
            "  python3 pangolin_amazon.py --asin B0G4QPYK4Z --parser amzVariantAsin\n"
            "  python3 pangolin_amazon.py --auth-only\n"
        ),
    )
