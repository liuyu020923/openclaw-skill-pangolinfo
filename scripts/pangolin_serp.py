...
Usage:
    pangolin_serp.py --q "quantum computing"
    pangolin_serp.py --q "best databases 2025" --mode serp --screenshot
    pangolin_serp.py --q "best databases 2025" --mode serp-plus
    pangolin_serp.py --q "kubernetes" --follow-up "how to deploy"
    pangolin_serp.py --auth-only
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "Examples:\n"
            '  python3 pangolin_serp.py --q "what is quantum computing"\n'
            '  python3 pangolin_serp.py --q "best databases 2025" --mode serp --screenshot\n'
            '  python3 pangolin_serp.py --q "best databases 2025" --mode serp-plus\n'
            '  python3 pangolin_serp.py --q "kubernetes" --follow-up "how to deploy"\n'
            "  python3 pangolin_serp.py --auth-only\n"
        ),
    )
